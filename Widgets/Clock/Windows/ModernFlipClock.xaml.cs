...
namespace Clock.Windows
{
    ...
    /// </summary>
    public partial class ModernFlipClock : Window
    {
        ...
        private void UpdateAeroGlass()
        {
            ...
            var rgn = WinAPI.CreateRoundRectRgn((int)(100 * App.Settings.Scale * dpiX), (int)(25 * App.Settings.Scale * dpiY),
                (int)((this.Width - 100) * App.Settings.Scale * dpiX), (int)(201 * App.Settings.Scale * dpiY),
            ...
            ForecastPanel.Dispatcher.Invoke((Action)delegate
                                                        {
                                                            if (currentWeather.ForecastList.Count >= 5)
                                                            {
                                                                ...
                                                                {
                                                                    if (item.GetType() == typeof(ModernForecastItem))
                                                                    {
                                                                        var forecastItem = (ModernForecastItem)item;
                                                                        ...
                                                                        forecastItem.Low.Text = currentWeather.ForecastList[i].LowTemperature + "°";
                                                            ...
                                                            ((ModernForecastItem)ForecastPanel.Children[0]).DayName.Text = Properties.Resources.Today;
                                                            ((ModernForecastItem)ForecastPanel.Children[2]).DayName.Text = Properties.Resources.Tomorrow;
