...
namespace Clock.Windows
{
    ...
    /// </summary>
    public partial class WideFlipClock : Window
    {
        ...
        private void UpdateAeroGlass()
        {
            ...
            var rgn = WinAPI.CreateRoundRectRgn((int)(6 * App.Settings.Scale * dpiX), (int)(40 * App.Settings.Scale * dpiY),
                (int)((this.Width - 6) * App.Settings.Scale * dpiX), (int)(170 * App.Settings.Scale * dpiY),
            ...
            ForecastPanel.Dispatcher.Invoke((Action)delegate
                                                        {
                                                            ...
                                                            ((WideForecastItem)ForecastPanel.Children[0]).DayName.Text = Properties.Resources.Today;
                                                            ((WideForecastItem)ForecastPanel.Children[2]).DayName.Text = Properties.Resources.Tomorrow;
